            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <select {...register('topic')} className={`${tokens.input} bg-white`}>
                  <option>Algebra</option><option>Geometry</option><option>Trigonometry</option>
                </select>
              ...
              <div>
                ...
                <select {...register('subTopic')} className={`${tokens.input} bg-white`}>
                  <option>Linear Equations</option><option>Quadratic Equations</option>
                </select>
              </div>
            </div>
                  ...
                  <div className="flex gap-4 pt-2">
                    {(['Easy','Medium','Difficult'] as const).map(d => (
                      <label key={d} className="flex items-center gap-2 text-sm text-[#374151]">
                        <input type="radio" value={d} {...register('difficulty')} className="accent-[#1B5DEF]" />{d}
                      </label>
                    ))}
                  </div>
